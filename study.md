...
ASR:
  DoubaoASR:
    ...
    type: doubao
    appid: "8303466037"
    access_token: a5Scmlc8doy6Bx2mA-5neCrMXVhQXBh9L
    output_dir: tmp/
...
TTS:
  ...
  DoubaoTTS:
    ...
    output_dir: "tmp/"
    appid: "api-key-20250306135638"
    token: 1458d9bb-0bc1-4e81-88ac-61241219496fa
    cluster: ark+cn-beijing
  GoSherpaTTS:
    type: gosherpa
...
LLM:
  ChatGLMLLM:
    ...
    api_key: a018c254bea214baf9b0fe5111103fbc2.JqML6BKDD67OsX7W
  OllamaLLM:
    # 定义LLM API类型
    type: ollama
